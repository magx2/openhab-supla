...
public class SuplaServerDeviceConfigActions extends SuplaServerActionsSupport {
    ...
    public static void setDeviceConfig(@Nullable ThingActions actions, String... deviceConfigs)
            throws InterruptedException, TimeoutException {
        ((SuplaServerDeviceConfigActions) requireNonNull(actions)).setDeviceConfig(deviceConfigs);
    }

    public static void setDeviceConfig(@Nullable ThingActions actions, Collection<String> configs)
            throws InterruptedException, TimeoutException {
        ((SuplaServerDeviceConfigActions) requireNonNull(actions)).setDeviceConfig(configs);
    }
}
