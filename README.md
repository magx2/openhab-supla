...
- [Zamel mSBW-02](https://supla.zamel.com/product/sterownik-bramowy-wi-fi-2-kanalowy-msbw-02/) 🎁 Discover the smallest of Supla by Zamel’s gate controllers! The mSBW-02 gate controller can be integrated with any gate operator or wicket door and allows remote control of the gate via the Supla mobile app. The device is designed for direct installation within the operator. Thanks to its universal 12–24 V power supply, it can be used in a wide range of applications. By connecting signals from limit switches to the controller’s inputs, you receive information about whether the gate or wicket is open or closed.
